    ...
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        <div className="flex items-center justify-center">
            <div className="relative">
                ...
                >
                    <Image src="/memoji.jpg" 
                    alt="Hailee portrait"
                    width = "150"
                    height = "150"
                    quality = "95"
                    priority = {true}
                    className="h-25 w-25 rounded-full object-cover border-[0.3rem] border-white shadow-xl"
                    />
                </motion.div>
        ...
        >
            <span className="font-bold">Hello, I'm Hailee.</span> I'm a{" "}
            <span className="font-bold">computer science student</span> at{" "}
            <span className="font-bold">New York University</span> 4 years of experience. I enjoy
            building <span className="">sites & apps and learning to use new technologies</span>.
        </motion.h1>
        ...
        >
            ...
            <a className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110
                hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60" 
                href="/Resume.pdf" download={true}>
                Download resume <HiDownload className="opacity-60 group-hover:translate-y-1 transition"/>
            </a>

            <a className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15]
                hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
                href="https://www.linkedin.com/in/hailee-yun/" target="_blank"
                >
                <BsLinkedin/>
            </a>
            <a className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15]
                ...
                href="https://github.com/haileeyun" target="_blank"
                >
                <FaGithubSquare/>
            </a>
        </motion.div>
